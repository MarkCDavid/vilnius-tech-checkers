...
public class FourPlayerCheckersCaptureConstraints implements CaptureConstraints {

    public FourPlayerCheckersCaptureConstraints(Board board, MoveHistory history, Move move) {
        this.move = move;
    }
