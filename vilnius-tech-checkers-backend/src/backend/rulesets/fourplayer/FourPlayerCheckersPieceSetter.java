...
public class FourPlayerCheckersPieceSetter extends CoordinateValidator {

    public FourPlayerCheckersPieceSetter(int rowFrom, int rowTo, int columnFrom, int columnTo) {
