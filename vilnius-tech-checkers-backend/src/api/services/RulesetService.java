...
public class RulesetService implements api.endpoints.RulesetService {
    ...
    public List<Ruleset> getRulesets() {
        return List.of(
                new Ruleset(EnglishCheckers.OID, "English Checkers"),
                new Ruleset(TurkishCheckers.OID, "Turkish Checkers"),
                new Ruleset(FourPlayerCheckers.OID, "Four Player Checkers")
                //new ItalianCheckers(),
